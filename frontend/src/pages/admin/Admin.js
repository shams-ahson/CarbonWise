...
const Admin = () => {
  ...
  const fetchResources = async () => {
    try {
      const response = await axios.get('https://carbon-wise-neon.vercel.app//api/resources');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://carbon-wise-neon.vercel.app//api/resources', newResource, {
        headers: { Authorization: `Bearer ${token}` },
      });
